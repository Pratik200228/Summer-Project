...
projects = [
    {
        ...
        "repo": "https://github.com/Pratik200228/gp-extractor",
        "demo": None,
    },
    {
        "title": "Cost Analysis Dashboard",
        "description": (
            "Interactive Tableau dashboard visualising ROI, residual income, and variance "
            "analysis across business units, connected to a live SQL Server data source."
        ),
    ...
    },
    {
        ...
        "description": (
            "Next.js + Mapbox itinerary builder that optimises multi-stop routes to "
            "waterfalls, trails, and nightlife spots across Tennessee."
        ),
        "tech": ["Next.js", "Mapbox", "Tailwind CSS"],
        "repo": None,
        "demo": None,
    },
]
